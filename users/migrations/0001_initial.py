        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.UUIDField(blank=True, null=True, verbose_name="Токен подтверждения email"),
                ),
                ("reset_password_token", models.UUIDField(blank=True, null=True, verbose_name="Токен сброса пароля")),
                (
                    "reset_password_token_created_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Время создания токена сброса"),
                ),
                (
                    "groups",
